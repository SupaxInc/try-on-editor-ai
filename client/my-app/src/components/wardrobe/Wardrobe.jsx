...
const Wardrobe = ({ itemSprites }) => {
  ...
  useEffect(() => {
    ...
    if (!wardrobeContainerRef.current) {
      ...
      wardrobeContainerRef.current =
        appRef.current.stage.getChildByLabel("wardrobeContainer");
    ...
    if (!itemsContainerRef.current) {
      ...
      itemsContainerRef.current =
        wardrobeContainerRef.current.getChildByLabel("itemsContainer");
